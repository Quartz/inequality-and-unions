...
var thingName = "inequality-and-unions";
var thingPath = qzdataPath + "/2017/inequality-and-unions";
...
function compileJadeTask() {
	...
	return gulp.src(config.paths.src.jade + "/index.jade")
		.pipe(jade({ pretty: true, locals: context }))
...
copyAssetsTask.description = "Copy favicon to build path";
